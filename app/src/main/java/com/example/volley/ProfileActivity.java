...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // getting the intents and send from main activity
        ...
        // set on click listener to developer url so as to open the link using implicit intent
        ...
        // set on click listener to the image button share profile and implement implicit intents sharing developers profile
